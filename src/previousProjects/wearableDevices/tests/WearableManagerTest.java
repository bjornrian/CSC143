...
import previousProjects.wearableDevices.classes.WearableManager;
...
public class WearableManagerTest {
    private static final String PATH = "src/previousProjects.wearableDevices/tests/WearablesSample.txt";
